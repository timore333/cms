@if(auth()->user()->hasPermission('access medical'))
    ...
    <li>
        ...
        <ul aria-expanded="false" class="collapse">
            {{--        <li><a href="{{route('patients.index')}}">@lang('thnaya.left_side_bar.medical.patients') <i class="fa fa-wheelchair "></i></a></li>--}}
            ...
            <li><a href="#">@lang('general.patients') <i class="fa fa-wheelchair "></i></a></li>
