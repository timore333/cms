            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title"> {{$__('general.all_users')}}
                            <inertia-link class="btn btn-success d-none d-lg-block pull-right" href="/users/create"
                                          method="get">
                                <i class="fa fa-plus-circle"></i> {{$__('general.new_user')}}
                            </inertia-link>
                        </h4>
